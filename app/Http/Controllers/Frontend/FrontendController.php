...
class FrontendController extends Controller
{
    public function index(){
        ...
        return view('frontEnd.layouts.pages.index', compact('hero_section_posts', 'trending_posts', 'home_category_posts', 'latest_home_blogs', 'latest_sidebar_blogs', 'popular_sidebar_blogs','home_categories','feature__post'));
    }
    ...
    public function addsubscriber(Request $request)
    {
        ...
        if ($existingSubscriber) {
            ...
            $store->status = 0;
            $store->save();
            Toastr::success('Your email subscribe successfully');
            return redirect()->back();
        }
    }
