...
class BlogController extends Controller
{
    ...
    {
        $data = Blog::orderBy('id','DESC')->with('category')->get();
        return view('backEnd.blog.index',compact('data'));
    }
    public function create()
    {
        $categories = BlogCategory::orderBy('id','DESC')->select('id','title')->get();
    ...
    public function edit($id)
    {
        ...
        return view('backEnd.blog.edit',compact('edit_data','categories'));
    }
